...
def fit_cox_proportional_hazards(
    df: pd.DataFrame, duration_col: str, event_col: str, covariates: list
) -> CoxPHFitter:
...
def plot_survival_curve(
    kmf: KaplanMeierFitter, title: str, output_path: Path, plot: bool = False
):
    """Plot survival curve"""
    if plot:
